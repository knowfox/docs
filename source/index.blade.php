...
<section class="container max-w-2xl mx-auto px-6 py-10 md:py-12">
    <div class="flex flex-col-reverse mb-10 lg:flex-row lg:mb-24">
        <div class="mt-8">
            ...
            <p class="text-lg">{!! $page->siteSummary !!}</p>

            <div class="flex my-10">
                <a href="/docs/overview" class="bg-blue hover:bg-blue-dark font-normal text-white hover:text-white rounded mr-4 py-2 px-6">Read the documentation</a>

                <a href="https://knowfox.com" title="Try Knowfox" class="bg-grey-light hover:bg-grey-dark text-blue-darkest font-normal hover:text-white rounded py-2 px-6">Try Knowfox</a>
            </div>
        </div>
